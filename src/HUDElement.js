class HUDElement
{
	...
	add(object)
    {
		...
		if (object === this) {
			console.error("HUDElement.add: object can't be added as a child of itself.", object);
			return this;
		}
    ...
    draw(t)
    {
        throw new Error('HUDElement.draw: Method not implemented.', this.type);
    }
}
